...
class __TwigTemplate_69ace94c1705ea31bc4a3fd4622bdb030d3880680baa3120dd81e39a07178b0c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        // line 98
        if (twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "events", [], "any", false, false, false, 98))) {
            // line 99
    ...
    ";
        // line 115
        if (twig_get_attribute($this->env, $this->source, ($context["profile"] ?? null), "parent", [], "any", false, false, false, 115)) {
            // line 116
            echo "        <h3 class=\"dump-inline\">
            Sub-Request ";
            // line 117
            echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["profile"] ?? null), "getcollector", [0 => "request"], "method", false, false, false, 117), "requestattributes", [], "any", false, false, false, 117), "get", [0 => "_controller"], "method", false, false, false, 117)]);
            echo "
            <small>
                ";
            // line 119
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "events", [], "any", false, false, false, 119), "__section__", [], "any", false, false, false, 119), "duration", [], "any", false, false, false, 119), "html", null, true);
            echo " ms
                <a class=\"newline\" href=\"";
            // line 120
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("_profiler", ["token" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["profile"] ?? null), "parent", [], "any", false, false, false, 120), "token", [], "any", false, false, false, 120), "panel" => "time"]), "html", null, true);
            echo "\">Return to parent request</a>
            </small>
        </h3>
    ";
        } elseif ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source,         // line 123
($context["profile"] ?? null), "children", [], "any", false, false, false, 123)) > 0)) {
            // line 124
            echo "        <h3>
            Main Request <small>";
            // line 125
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "events", [], "any", false, false, false, 125), "__section__", [], "any", false, false, false, 125), "duration", [], "any", false, false, false, 125), "html", null, true);
            echo " ms</small>
        </h3>
    ";
        }
    ...
    ";
        // line 129
        echo twig_call_macro($macros["helper"], "macro_display_timeline", [("timeline_" . ($context["token"] ?? null)), twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "events", [], "any", false, false, false, 129), ($context["colors"] ?? null)], 129, $context, $this->getSourceContext());
        echo "

    ";
        // line 131
        if (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["profile"] ?? null), "children", [], "any", false, false, false, 131))) {
            // line 132
            echo "        <p class=\"help\">Note: sections with a striped background correspond to sub-requests.</p>

        <h3>Sub-requests <small>(";
            // line 134
            echo twig_escape_filter($this->env, twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["profile"] ?? null), "children", [], "any", false, false, false, 134)), "html", null, true);
            echo ")</small></h3>

        ";
            // line 136
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["profile"] ?? null), "children", [], "any", false, false, false, 136));
            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                // line 137
                echo "            ";
                ...
                <small>";
                // line 140
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["events"] ?? null), "__section__", [], "any", false, false, false, 140), "duration", [], "any", false, false, false, 140), "html", null, true);
                echo " ms</small>
            </h4>

            ";
                // line 143
                echo twig_call_macro($macros["helper"], "macro_display_timeline", [("timeline_" . twig_get_attribute($this->env, $this->source, $context["child"], "token", [], "any", false, false, false, 143)), ($context["events"] ?? null), ($context["colors"] ?? null)], 143, $context, $this->getSourceContext());
                echo "
        ";
            }
            $_parent = $context['_parent'];
    ...
    <script>";
        ...
        var requests_data = {
            \"max\": ";
        // line 462
        echo twig_escape_filter($this->env, sprintf("%F", twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "events", [], "any", false, false, false, 462), "__section__", [], "any", false, false, false, 462), "endtime", [], "any", false, false, false, 462)), "js", null, true);
        echo ",
            \"requests\": [
";
        // line 464
        echo twig_call_macro($macros["helper"], "macro_dump_request_data", [($context["token"] ?? null), ($context["profile"] ?? null), twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "events", [], "any", false, false, false, 464), twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "events", [], "any", false, false, false, 464), "__section__", [], "any", false, false, false, 464), "origin", [], "any", false, false, false, 464)], 464, $context, $this->getSourceContext());
        echo "

";
        // line 466
        if (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["profile"] ?? null), "children", [], "any", false, false, false, 466))) {
            // line 467
            echo "                ,
";
            // line 468
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["profile"] ?? null), "children", [], "any", false, false, false, 468));
            $context['loop'] = [
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                // line 469
                echo twig_call_macro($macros["helper"], "macro_dump_request_data", [twig_get_attribute($this->env, $this->source, $context["child"], "token", [], "any", false, false, false, 469), $context["child"], twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["child"], "getcollector", [0 => "time"], "method", false, false, false, 469), "events", [], "any", false, false, false, 469), twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "events", [], "any", false, false, false, 469), "__section__", [], "any", false, false, false, 469), "origin", [], "any", false, false, false, 469)], 469, $context, $this->getSourceContext());
...
";
    ...
    public function macro_dump_request_data($__token__ = null, $__profile__ = null, $__events__ = null, $__origin__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            // line 509
            $macros["__internal_44232f413df711d63943b3d36c2781e88fc2b9c80d2dd1bdd9315aa2974a5860"] = $this;
            // line 510
            echo "                {
                    \"id\": \"";
            // line 511
            ...
            echo "\",
                    \"left\": ";
            // line 512
            echo twig_escape_filter($this->env, sprintf("%F", (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["events"] ?? null), "__section__", [], "any", false, false, false, 512), "origin", [], "any", false, false, false, 512) - ($context["origin"] ?? null))), "js", null, true);
            echo ",
                    \"events\": [
";
            // line 514
            echo twig_call_macro($macros["__internal_44232f413df711d63943b3d36c2781e88fc2b9c80d2dd1bdd9315aa2974a5860"], "macro_dump_events", [($context["events"] ?? null)], 514, $context, $this->getSourceContext());
            echo "
                    ]
                }
";
...
";
    ...
    {
        return array (  1020 => 550,  1017 => 549,  1006 => 547,  1002 => 546,  998 => 544,  980 => 543,  953 => 537,  950 => 536,  931 => 534,  914 => 533,  910 => 531,  906 => 530,  902 => 529,  898 => 528,  894 => 527,  890 => 526,  886 => 525,  883 => 524,  881 => 523,  864 => 522,  848 => 520,  832 => 514,  827 => 512,  823 => 511,  820 => 510,  818 => 509,  799 => 507,  791 => 504,  757 => 472,  739 => 469,  722 => 468,  719 => 467,  717 => 466,  712 => 464,  707 => 462,  431 => 189,  387 => 147,  384 => 146,  381 => 145,  373 => 143,  367 => 140,  361 => 139,  358 => 138,  355 => 137,  351 => 136,  346 => 134,  342 => 132,  340 => 131,  335 => 129,  332 => 128,  326 => 125,  323 => 124,  321 => 123,  315 => 120,  311 => 119,  306 => 117,  303 => 116,  301 => 115,  292 => 108,  285 => 107,  274 => 103,  268 => 99,  266 => 98,  260 => 94,  254 => 91,  250 => 90,  246 => 88,  243 => 87,  240 => 86,  237 => 85,  231 => 84,  228 => 83,  223 => 82,  220 => 81,  218 => 80,  212 => 77,  208 => 76,  203 => 73,  201 => 72,  198 => 71,  191 => 67,  188 => 66,  186 => 65,  179 => 61,  171 => 56,  165 => 52,  162 => 51,  155 => 50,  144 => 45,  141 => 44,  134 => 43,  125 => 40,  122 => 39,  116 => 36,  109 => 32,  105 => 30,  103 => 29,  100 => 28,  94 => 25,  89 => 24,  87 => 23,  84 => 22,  81 => 21,  78 => 20,  76 => 19,  73 => 18,  70 => 17,  63 => 16,  55 => 1,  52 => 6,  50 => 5,  48 => 3,  38 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "@WebProfiler/Collector/time.html.twig", "/var/www/AntoineLemaire/test-annotation/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/time.html.twig");
    }
}
